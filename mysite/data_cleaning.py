...
csv_file="C:\\Users\\Commander\\Documents\\Upenn\\Hackathon\\comments.csv"
...
split_df[split_df.Comment == '\n']


# In[12]:


len(split_df.iloc[8].Comment)
...
csv_file_2="C:\\Users\\Commander\\Documents\\Upenn\\Hackathon\\dijkstra algorithm.csv"
...
cleaned_df_new_2000.head()


# In[34]:


#statistics=cleaned_df_new_2000.groupby(['Video ID','Title','cluster'])['cluster'].count().reset_index(name="count")
...
#statistics['pos_neg_comm']=
#statistics.pivot(index=['Video ID','Title'], columns=['cluster'], values=['count'])
